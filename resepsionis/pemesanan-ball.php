...
<head>
    ...
    <title>Resepsionis - Ballroom - Asmara Group</title>
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light shadow mb-4">
                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="pemesanan-ball.php">Pemesanan Ballroom</a>
                        </li>
                        </ul>
                    ...
                    <div class="container">
                            ...
                            <div class="card shadow mb-9">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary text-center">Formulir Pemesanan Ballroom</h6>
                                </div>
                                    <div class="card-body">
                                        ...
                                        <p class="text-center text-primary">Masukkan Tanggal Pemakaian</p>
                                        <div class="form-group">
                                                    <input 
                                                    type="date" 
                                                    name="datang"
