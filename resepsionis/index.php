                        ...
                        <div class="col-lg-9 mb-7">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary text-center">Formulir Pemesanan</h6>
                                </div>
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <input type="text" class="form-control form-control-user" name="namadepan"
                                                    placeholder="Depan">
                                            </div>
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <input type="text" class="form-control form-control-user" name="namabelakang"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <select name="dewasa" id="pet-select">
                                                    <option value="">Jumlah Tamu (Dewasa)</option>
                                                    <option value="1">1</option>
                                                    <option value="2">2</option>
                                                    <option value="3">3</option>
                                                    <option value="4">4 (Jumlah maksimal dengan pilihan kamar)</option>
                                                </select>
                                            </div>

                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <select name="anak" id="pet-select">
                                                    <option value="">Jumlah Tamu (Anak < 12 Tahun)</option>
                                                    <option value="1">1</option>
                                                    <option value="2">2</option>
                                                    <option value="3">3</option>
                                                    <option value="4">4 (Jumlah maksimal dengan pilihan kamar)</option>
